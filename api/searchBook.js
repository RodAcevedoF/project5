...
export const searchBook = async (query = "", startIndex = 0, maxResults = 10, category = "", maxPages = Infinity) => {
  try {
      ...
      const books = response.data.items
        .map((item) => {
          ...
          return {
            ...
            publish_date: publishedDate || "No description",
        ...
        .filter((book) => book.pages === null || book.pages <= maxPages); // Aplicar el filtro de páginas
